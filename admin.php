    ...
    <div class="infon_admin flex m-20">
        <div class="tout_les_article m-20">
            ...
            <div class="tout_les_article">
                <a href="ajout_article.php" class="button_add">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="sup_articles.php?idArticles=<?php echo $resu[$i]['idArticles'] ?>" class="button_add ">
        ...
        <a href="add_users.php" class="button_add ">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="sup_articles.php?idusers=<?php echo $sele[$i]['idusers']; ?>" class="button_add">
                                    <button id="lien_admin">Suprimer</button>
                                </a>
